...
def __get_attendance(roll_no,course_name,month_name):
    ...
    try:
        ...
        count_for_div_for_month = Period.objects.filter(timetable__lecture__div=student.div)
        ...
        count_for_div_for_month_for_course = Period.objects.filter(timetable__lecture__course__name=course_name).filter(timetable__lecture__div=student.div)
